...
const Analitik = () => {
  return (
    <div className="flex w-full p-6 justify-center">
      <div className="bg-white rounded-lg p-8 shadow-lg flex flex-col w-full">
        ...
        <div className="w-full flex items-start gap-2 justify-between rounded-lg h-full">
          {/* card kiri */}
          <div className="border rounded-md border-gray-400 flex-[2] flex flex-col p-4 h-full">
            <div className="flex flex-col">
              <div className="text-md font-semibold">Ringkasan hari ini</div>
              <div className="flex justify-between mt-2 gap-2 flex-row">
                <div className="flex-1 bg-neutral-200 w-auto items-start p-4 rounded-lg justify-center flex-col">
                  <div>Device</div>
                  <div>RMX3263</div>
                </div>
                <div className="flex-1 text-xs bg-neutral-200 w-14 items-start p-4 rounded-lg justify-center flex-col">
                  <div>Aktif sejak</div>
                  <div>29.8.2023</div>
                </div>
              </div>
          ...
          {/* card kanan */}
          <div className="flex-[4] border rounded-md border-gray-400 p-6 h-full flex flex-col justify-between">
